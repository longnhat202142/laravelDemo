  ...
  <div class="  d-flex" style="justify-content:center">
            ...
            <ul class="nav">
                ...
                <li class="nav_item" style=" position: static;" id="container1" >
                    ...
                    <a  class="nav-link active item_link " aria-current="page" href="#">
                ...
                <li class="nav_item" style=" position: static;" id="container2">
                    <div>
                    <h4 style=" letter-spacing: 1px;">
                    <a class="nav-link active item_link "  style="color:white;text-decoration: none;" aria-current="page" href="#">GIỚI THIỆU</a>
                    </h4>
                    </div> 
                    <div class="item_list" >
                      <ul class="item_ul">
