...
<div class="row main">
  ...
  @endif
    ...
    <div class="col-4" style="">
      <a href="{{ route('search_detail_tt', ['id' => $item->IDTinTuc]) }}">
      <img class="border border-0 rounded-2"
      src="{{!empty($item->Anh) ? asset('public/storage/AnhDaiDien/' . $item->Anh) : 'https://duonganh.com.vn/en/admin/assets/images/404.png' }}"
      alt="" style="max-width: 320px;margin-top:10px; width: 320px; height: 200px">
      </a>
      <div class="img">
      </div>
    ...
    @endif
      ...
      href="{{ route('search_detail_tt', ['id' => $item->IDTinTuc]) }}">{{$item->TieuDe}}</a>
      </h4>
      <div class="time">
      <span style="color: #aca9a9">
      <img src="	https://husc.edu.vn/images/icon-calendar.png" alt="">
      ...
      <hr style="color: #aca9a9">
      <span style="color: #aca9a9">Chuyên mục:
      <a class="text-decoration-none" style="color: #134980; font-size: small"
        href="#">{{$item->IDDanhMuc}}</a>
      </span>
      </div>
      <hr style="color: #aca9a9">
      <div class="decription" style="margin-bottom: 40px;text-overflow: ellipsis;
